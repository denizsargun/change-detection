classdef util < handle
    ...
    methods
        ...
        function setup(obj)
            ...
            obj.ex.beta = obj.ex.alpha+rand*(obj.ex.alphabet(end)-obj.ex.alpha);
            ...
            suffix = strcat('N',num2str(log(obj.ex.alphabetSize)/log(3)),'M', ...
                num2str(obj.ex.sampleSize/obj.ex.alphabetSize));
            % try .xls or .xlsx
            obj.ex.storageFile = ...
                char(strcat('experiment','_',suffix,'_',dateName,'.xls'));
