classdef utility < handle
    ...
    methods
        ...
        function setup(obj)
            ...
            xlwrite(obj.ex.storageFile,obj.ex.pdIt,1,'K1');
        ...
        function iProjSet = i_proj(obj,dist,meanRange)
        ...
        function plot(obj)
            for i = 1:length(obj.ex.testNames)
                ...
                pfa = xlsread( ...
                    ...
                    '_','pfa'));
                pd = xlsread(obj.ex.storageFile, ...
                    strcat(obj.ex.testNames{i},'_','pd'));
                pfaMean = mean(pfa);
                pfaStd = std(pfa);
        ...
        function kl_pd(obj)
            ...
            obj.ex.testTime = toc(testTimeTemp)/obj.ex.pdIt(1);
            obj.ex.performance = numberOfMisdetections/obj.ex.pdIt(1);
            obj.write_excel()
        end
        
        function mean_pd(obj)
            numberOfMisdetections = 0;
            testTimeTemp = tic;
            for i = 1:obj.ex.pdIt(2)
                obj.ex.changedDist = obj.random_dist_mean(obj.ex.beta);
                empDist = obj.realize(obj.ex.changedDist);
                numberOfMisdetections = numberOfMisdetections ...
            ...
            obj.ex.testTime = toc(testTimeTemp)/obj.ex.pdIt(2);
            obj.ex.performance = numberOfMisdetections/obj.ex.pdIt(2);
            obj.write_excel()
        end
        ...
        function lmp_pd(obj)
            ...
            obj.ex.testTime = toc(testTimeTemp)/obj.ex.pdIt(3);
            obj.ex.performance = numberOfMisdetections/obj.ex.pdIt(3);
            obj.write_excel()
        end
        ...
        function glr_pd(obj)
            ...
            obj.ex.testTime = toc(testTimeTemp)/obj.ex.pdIt(4);
            obj.ex.performance = numberOfMisdetections/obj.ex.pdIt(4);
            obj.write_excel()
        end
