...
meanThr1 = mean(quantd18O)+0.1*std(quantd18O);
...
subplot(2,1,1)
yyaxis left
plot(years(1:75:end-74),rolSumQuantd18O,'b')
grid minor
yyaxis right
plot(years(1:75:end-74-457),rolSumQuantIceAcc,'r')
...
subplot(2,1,2)
yyaxis left
plot(years(1:75:end-74),rolDistn1,'b')
grid minor
yyaxis right
plot(years(1:75:end-74-457),rolDistn2,'r')
